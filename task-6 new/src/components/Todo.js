...
import { getFirestore, collection, addDoc, onSnapshot, serverTimestamp, updateDoc, doc} from "firebase/firestore";
...
const Todo = ({ user }) => {
  ...
  Todo.propTypes = {
    user: PropTypes.shape({
      ...
      // Add other expected properties of the 'user' object
    }).isRequired,
  };
